...
Recall that you learned how to create composite plots in Module 6. If you need a refresher on how to create these plots, review that module. You can also check [Composing Plots (Links to an external site.)](https://holoviz.org/tutorial/Composing_Plots.html) in the hvPlot documentation.
